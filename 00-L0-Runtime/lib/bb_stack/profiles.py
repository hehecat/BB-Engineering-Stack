...
WORKFLOW_FILES = {
    ...
    "assessment": "assessment-core.md",
    "ctf": "ctf-core.md",
    "lab": "lab-core.md",
    "analysis": "analysis-core.md",
}
...
class ProfileRegistry:
    ...
    def render(
        ...
        *,
        ...
        active_mode = (
            str(engagement_data["mode"])
            if engagement_data is not None
            else str(profile["default_mode"])
        )
        mode_contract = self._mode_contract(active_mode)
        header = (
            "<!-- Generated by bb-stack; edit source fragments, not this file. -->\n"
            f"<!-- profile={name} workflow={profile['workflow']} "
            f"platform={platform} mode={active_mode} -->\n\n"
        )
